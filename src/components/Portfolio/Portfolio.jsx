...
export default function Portfolio() {
  ...
  return (
    <>
      <Helmet>
        <title>Lion Pro Dev | Projects</title>
        <meta
          name="description"
          content="iOs, Android, and web projects for professional web and mobile development."
        />
        <link rel="canonical" href="https://lionprodev.com/projects" />
      </Helmet>
