          ...
          <div className={s.processWrapper}>
            <Fade cascade>
              <div className={s.processItem}>
                ...
                <p>
                  An effective app strategy includes competitor research,
                  business goals, and a product roadmap.
                </p>
              </div>
              ...
              <div className={s.processItem}>
                ...
                <h4>Testing</h4>
                <p>
                  When app development is complete, we perform thorough testing
                  to deliver a stable, usable, and secured product.
                </p>
              </div>
            </Fade>
          </div>
